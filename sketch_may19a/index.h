...
<html>
   ...
   <body>
      <div class="widget">
         ...
         <div class="upper">
            <div class="place update" id="temperature">- &deg;C</div>
            <div class="date" id="date">-</div>
            <div class="message" id="message">-</div>
         </div>
         <div style="text-align: center;"><a href="" style="align:center">Proiect ADIV</a></div>
         <div class="lower">
            <ul class="infos">
               <li class="info temp">
                  <h2 class="title">TEMPERATURA</h2>
                  <span class='update' id="temp">- &deg;C</span>
               </li>
               <li class="info altitude">
                  <h2 class="title">ALTITUDINE</h2>
                  <span class='update' id="altitude">- m</span>
               </li>
               <li class="info weather">
                  <h2 class="title">PRESIUNE</h2>
                  <span class="update" id="pressure">- mbar</span>
               </li>
               <li class="info wind">
                  <h2 class="title">PRECIPITATII</h2>
                  <span class='update' id="rain">-%</span>
               </li>
               <li class="info humidity">
                  <h2 class="title">UMIDITATE</h2>
                  <span class='update' id="humidity">-%</span>
               </li>
            </ul>
         </div>
      </div>
      <script>
         ...
         function drawClock(){
             ...
             var today  = new Date();
             document.getElementById("date").innerHTML = today.toLocaleDateString("ro-RO", options);
             ...
             xhttp.onreadystatechange = function() {
               ...
               var obj = JSON.parse(txt);
                 ...
                 document.getElementById("pressure").innerHTML = Math.round(obj.Pressuremb) + " mbar";
